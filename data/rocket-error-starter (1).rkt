...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |rocket-error-starter (1)|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
